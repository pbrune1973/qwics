...
public class QwicsTopic implements QueueWrapper {
	private Topic topic = null;
	private Connection con = null;
	private Session sess = null;
	

	public QwicsTopic(ConnectionFactory cf, Topic topic) throws Exception {
		this.topic = topic;
	...
	public void get(HashMap<String, Object> msgHeader, char[] msgBody) throws Exception {
		MessageConsumer receiver = sess.createConsumer(topic);
	...
	public void put(HashMap<String, Object> msgHeader, char[] msgBody) throws Exception {
		MessageProducer sender = sess.createProducer(topic);
		...
		try {
			InitialContext ctx = new InitialContext();
    			Queue dest = (Queue)ctx.lookup("java:/jms/topic/"+msgHeader.get("REPLYTOQ"));
    			ctx.close();    		    			
