                ...
                if (i == old_i) {
                    ...
                    while ((buf[i] != ')') || (bracketLevel > 0)) {
                        ...
                        if (buf[i] != ' ') {
                            ...
                            if ((i+2) < m) {
                                if ((buf[i+1] == 'I') && (buf[i+2] == 'N') && 
                                    (((i+3) == m) || (buf[i+3] == ' '))) {
                                    token[tokenPos] = toupper(buf[i]);
                                    tokenPos++;     
                                }
                                if ((buf[i+1] == 'O') && (buf[i+2] == 'F') && 
                                    (((i+3) == m) || (buf[i+3] == ' '))) {
                                    token[tokenPos] = toupper(buf[i]);
                                    tokenPos++;     
                                }
                            ...
                            if (i >= 13) {
                                if ((buf[i-2] == 'I') && (buf[i-1] == 'N') && 
                                    (((i-3) <= 11) || (buf[i-3] == ' '))) {
                                    token[tokenPos] = toupper(buf[i]);
                                    tokenPos++;     
                                }
                                if ((buf[i-2] == 'O') && (buf[i-1] == 'F') && 
                                    (((i-3) <= 11) || (buf[i-3] == ' '))) {
                                    token[tokenPos] = toupper(buf[i]);
                                    tokenPos++;     
                                }
                ...
                if ((buf[i] == ' ') || (buf[i] == '\n') ||
                    ...
                    if (tokenPos > 0) {
                        ...
                        if (value == 1) {
                            ...
                            if (isResponseParam) {
                                printJavaCmd(execbuf,"%s%s%s%s%s\n","           DISPLAY \"TPMI:",
